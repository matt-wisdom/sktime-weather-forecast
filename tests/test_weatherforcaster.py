...
from weatherapi.weather_forecaster import (create_condition_predictor,
                                           generate_ts_classification_data,
                                           generate_ts_prediction_X,
                                           main_forecaster, make_forecaster)
...
def test_create_condition_predictor():
    ...
    assert le.inverse_transform(data.condition_labels).tolist() == df["conditions"].to_list()
